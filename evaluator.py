...
async def evaluate_query(evaluator, query: str, expected_devices: List[Dict]) -> Dict:
...
async def evaluate_csv(csv_path: str, output_path: str):
    ...
    for idx, row in enumerate(rows):
        ...
        evaluation = await evaluate_query(evaluator, query, expected_devices)
...
async def main():
    await evaluate_csv('dataset.csv', 'evaluation_report.json')
